...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s eirebit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  eirebit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded eirebit transaction") + "\n" +
              "  eirebit-tx [options] -create [commands]   " + _("Create hex-encoded eirebit transaction") + "\n" +
              "\n";
