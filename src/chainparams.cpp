...
{
    const char* pszTimestamp = "On this day in 2021 Ireland reached 6406634 vaccine doses";
    const CScript genesisOutputScript = CScript() << ParseHex("040984710fa689ad5023690c80f3a79c8f13f8d45b8c857fbcbc9bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1517356801; // January 31st, 2018
        ...
        genesis = CreateGenesisBlock(1629567006, 2000321856, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xddb548362551662bee1dcdbc368bf4b72f82901042cef82ac73778b91769ccca"));
        assert(genesis.hashMerkleRoot == uint256S("0x3e5cd35598f7c18256e5b39b4d2219e46ed6b299c3d680ed0bb03a8aaacd9e76"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("52.16.204.9", "52.16.204.9", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("eirebittools.com", "dnsseed.eirebittools.com"));
        //vSeeds.push_back(CDNSSeedData("eirebitpool.org", "dnsseed.eirebitpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
              ( 0, uint256S("0xddb548362551662bee1dcdbc368bf4b72f82901042cef82ac73778b91769ccca"))
        ...
        chainTxData = ChainTxData{
            ...
            1629567006, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1629567006, 855997, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x79dede896b8f1294a9aa733be6ea430d8b8aca2ab91005e4b9ae38fcdc6824ad"));
        assert(genesis.hashMerkleRoot == uint256S("0x3e5cd35598f7c18256e5b39b4d2219e46ed6b299c3d680ed0bb03a8aaacd9e76"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("52.16.204.9", "52.16.204.9"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.eirebit.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x79dede896b8f1294a9aa733be6ea430d8b8aca2ab91005e4b9ae38fcdc6824ad")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1629567006, 0, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd4177b4b18e5883796adad296a15b50dada508cf850866ff974645c9a433be3a"));
        assert(genesis.hashMerkleRoot == uint256S("0x3e5cd35598f7c18256e5b39b4d2219e46ed6b299c3d680ed0bb03a8aaacd9e76"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xd4177b4b18e5883796adad296a15b50dada508cf850866ff974645c9a433be3a"))
        };
