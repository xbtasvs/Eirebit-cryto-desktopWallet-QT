...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Eirebit Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Eirebit Core"
...
#define PACKAGE_BUGREPORT "https://github.com/eirebit-project/eirebit/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Eirebit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Eirebit Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "eirebit"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://eirebit.org/"
