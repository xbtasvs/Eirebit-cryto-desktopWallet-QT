...
const char * const BITCOIN_CONF_FILENAME = "eirebit.conf";
const char * const BITCOIN_PID_FILENAME = "eirebit.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Eirebit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Eirebit";
#else
    // Unix
    return pathRet / ".eirebit";
#endif
#endif
}
